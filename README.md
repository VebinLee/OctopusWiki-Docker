...
- 项目看板 PC 端新增右击菜单“新建任务”。
- 增强项目看板进度管理功能，允许在新建任务时，设置任务进度。
- 修复回收站项目看板点击“查看”时，toast 提示“项目不存在”问题。
- 实现文件树的 Markdown 文件名与文档 H1 标题的双向联动。
- 增强其它文档 Canvas/Excalidraw/项目看板/图片/视频 重命名联动功能。
